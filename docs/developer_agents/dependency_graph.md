...
| `connections/available_models.py` | `types`, `model_cache`, `proxdash`, `model_registry`, `provider_connector`, `model_configs`, `logging/utils`, `state_controller`, `type_utils` |
...
| `connectors/provider_connector.py` | `types`, `logging/utils`, `query_cache`, `type_utils`, `stat_types`, `hash_serializer`, `proxdash`, `model_configs`, `state_controller` |
| `connectors/model_registry.py` | `provider_connector`, `types`, `model_configs`, *all providers* |
...
| `connectors/providers/deepseek.py` | `types`, `openai_mock`, `provider_connector` |
| `connectors/providers/grok.py` | `types`, `openai_mock`, `provider_connector` |
| `connectors/providers/mock_provider.py` | `types`, `provider_connector` |

### Main Entry Point

| File | Imports |
|------|---------|
| `proxai.py` | `types`, `type_utils`, `provider_connector`, `model_registry`, `query_cache`, `model_cache`, `type_serializer`, `stat_types`, `available_models`, `proxdash`, `experiment`, `model_configs`, `logging/utils` |
...
Layer 3: model_registry ← providers/*
         │
Layer 2: provider_connector, proxdash, model_configs
         │
...
2. **`state_controller.py`** is used by all StateControlled classes (caches, proxdash, provider_connector, model_configs, available_models)
3. **`provider_connector.py`** is the heaviest single file - it coordinates caching, logging, and proxdash
4. **Providers** are leaf nodes - they only depend on `provider_connector` and `types`
